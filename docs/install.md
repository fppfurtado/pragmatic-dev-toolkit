...
2. Após instalar, abrir o Claude Code no workspace e confirmar que `/draft-idea`, `/note`, `/triage`, `/new-adr`, `/run-plan`, `/debug`, `/gen-tests`, `/release`, `/next`, `/init-config`, `/archive-plans` aparecem em `/help` ou `/plugin list`.
