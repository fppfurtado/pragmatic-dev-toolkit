...
| **I-X** | Pendente | — | Candidatos remanescentes naturais (com referência formal a ADR-052 disponível para aplicação de modos editoriais): **alinhamento/triage** (ADR-009+011+026+027+038+042, 6 ADRs com constraint análogo always-include sobre ADR-009 → modo (c) aplicável diretamente), **discoverability/branding** (ADR-037 + ?), **brainstorm** (ADR-036 standalone), **apex meta-cluster** (ADR-035+043+045+046+047+048+049+050+051+052 + ADR-034 preservado — opcional) |
