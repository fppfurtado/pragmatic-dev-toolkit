...
- Frontmatter mecânico válido: `grep -cE '^(name|description|roles|disable-model-invocation):' skills/scan-mechanicality/SKILL.md` retorna `5` (name, description, roles.required, roles.informational, disable-model-invocation).
