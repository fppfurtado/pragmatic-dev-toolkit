...
- Não pular o sanity check de documentação quando ele se aplica (passo 4.3) — skip só nas duas condições prescritas (`.md` já no plano e tocados, ou `## Resumo da mudança` sem nenhuma das categorias concretas de superfície user-facing). Em dúvida, perguntar.
